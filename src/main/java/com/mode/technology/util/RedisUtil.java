package com.mode.technology.util;
...
public class RedisUtil {
	...
	public Object brpop(String key, long timeout, TimeUnit timeUnit) {
		try {
			...
			e.printStackTrace();//在设定时间内没有值进入阻塞，直至超时返回null
			return null;
		}
	}
	 ...
	 * @param time  时间(秒)
	 */
	public void listRightPush(String key, String value, Long time) {
	...
	public Set<Object> hkeys(String taskCacheKey) {
		Set<Object> keys = redisTemplate.opsForHash().keys(taskCacheKey);
		return keys;
	}
